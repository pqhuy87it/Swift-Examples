...
open class AvatarCaptureController: UIViewController {
    ...
    func addOtherControls() {
        ...
        var cancelButton = UIButton(frame: CGRect(x:view.frame.origin.x + 20,
                                                 ...
                                                 width: 32,
                                                 height: 32))
        cancelButton = setButtonProperties(button: cancelButton, fontSize: 32, icon: .accusoft, selector: #selector(cancel))
        ...
        var cancelSelectPhotoButton = UIButton(frame: CGRect(x:(previousFrame?.origin.x)! + (previousFrame?.width)! - 32,
                                                            ...
                                                            width: 32,
                                                            height: 32))
        cancelSelectPhotoButton = setButtonProperties(button: cancelSelectPhotoButton, fontSize: 32, icon: .cat, selector: #selector(cancelSelectedPhoto))
    ...
    func addCameraControls() {
        ...
        swapCamerasButton = setButtonProperties(button: swapCamerasButton, fontSize: 25, icon: .accusoft, selector: #selector(swapCameras))
    ...
    func setButtonProperties(button: UIButton, fontSize: Int, icon: FontAwesome, selector: Selector) -> UIButton {
        ...
        button.titleLabel?.font = UIFont.fontAwesome(ofSize: CGFloat(fontSize), style: .light)
