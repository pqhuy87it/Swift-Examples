...
class ViewController: UIViewController {
    ...
    private lazy var customeView: CustomView = {
        ...
        let leading = NSLayoutConstraint(item: customeView,
                                         attribute: .leading,
                                         relatedBy: .equal,
                                         ...
                                         multiplier: 1.0,
                                         constant: 0.0)
        let trailing = NSLayoutConstraint(item: customeView,
                                          attribute: .trailing,
                                          relatedBy: .equal,
                                          toItem: self.bottomView,
                                          attribute: .trailing,
                                          multiplier: 1.0,
                                          constant: 0.0)
        let bottom = NSLayoutConstraint(item: customeView,
                                        attribute: .bottom,
                                        relatedBy: .equal,
                                        toItem: self.bottomView,
                                        attribute: .top,
                                        multiplier: 1.0,
                                        constant: CustomView.height)
        let height = NSLayoutConstraint(item: customeView,
                                        attribute: .height,
                                        relatedBy: .equal,
                                        toItem: nil,
    ...
    @IBAction func showOtherViewPressed(sender: AnyObject) {
        customeView.show()
    }
    
    @IBAction func hideOtherViewPressed(sender: AnyObject) {
        customeView.hide()
    }
}
